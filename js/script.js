...
function read (){
	...
	let text = '					<div class="2016">						<h2>2016</h2><br>						<ul>							<li><span class="font-author">Nakajima, Hirotaka</span>, <span class="font-author">Shigeya Suzuki</span>, Tetsuro Tokunaga; Kiyoshi Tanaka; Yasuhiko Miyazaki; Koichi Maruyama; Osamu Nakamura, "Out-of-Band Authentication Protocol for Digital Signage and Smartphone Interaction", Consumer Electronics (GCCE), 2016 IEEE 5th Global Conference on , vol., no., pp.319,321, 11-14 Oct. 2016.</li><br>							<li><span class="font-author">中島 博敬</span>; <span class="font-author">鈴木 茂哉</span>; 徳永 徹郎; 田中 清; 宮崎 泰彦; 丸山 剛一; 中村 修, "意図しないBLE接続を防ぐ デジタルサイネージ・スマートフォン連携システムの構築", マルチメディア，分散，協調とモバイル(DICOMO2016)シンポジウム, pp.1195,1199, 6-8 Jul. 2016.</li><br>							<li>Kyohei MATSUMOTO, Takafumi NAKANISHI and Takashi KITAGAWA, Evaluation Indexes of Customer Journey for Contents of Owned Media, Information Modelling and Knowledge Bases XXVIII, IOS Press, Vol.292 of Frontiers in Artificial Intelligence and Applications, pp. 362-369, (2017)</li>						</ul><br>					</div>					<div class="2013">						<h2>2013</h2><br>						<ul>							<li><span class="font-author">Nakajima, Hirotaka</span>, Isshiki, Masao; Takefuji, Yoshiyasu, "WebSocket proxy system for mobile devices," Consumer Electronics (GCCE), 2013 IEEE 2nd Global Conference on , vol., no., pp.315,317, 1-4 Oct. 2013.</li><br>							<li><span class="font-author">中島 博敬</span>; <span class="font-author">鈴木 茂哉</span>; 徳永 徹郎; 田中 清; 宮崎 泰彦; 丸山 剛一; 中村 修, "意図しないBLE接続を防ぐ デジタルサイネージ・スマートフォン連携システムの構築", マルチメディア，分散，協調とモバイル(DICOMO2016)シンポジウム, pp.1195,1199, 6-8 Jul. 2016.</li><br>						</ul><br>					</div>					<div class="2010">						<h2>2010</h2><br>						<ul>							<li>Yamada, Ikuya, Yamaki, Wataru, <span class="font-author">Nakajima, Hirotaka</span>, and Takefuji, Yoshiyasu. "Phroni: Augmenting Wikipedia Using Mashups." In AI Mashup Challenge 2010, in ESWC 2010: 7th Extended Semantic Web Conference (Heraklion, Greece 2010)</li><br>							<li>Yamada, Ikuya, Yamaki, Wataru, <span class="font-author">Nakajima, Hirotaka</span>, and Takefuji, Yoshiyasu. Ousia Weaver: A tool for creating and publishing mashups as impressive Web pages. In MEM 2010: 3rd Workshop on Mashups, Enterprise Mashups and Lightweight Composition on the Web, in WWW 2010: Proceedings of the 18th International World Wide Web Conference (Raleigh, North Carolina, USA 2010)</li><br>						</ul><br>					</div>';
